...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     '~/pvt/pvt3/gnuplot/prog-monte-carlo-0.dat' using 1:2 title "N=10^7" with linespoints ls 2,\
     '~/pvt/pvt3/gnuplot/prog-monte-carlo-1.dat' using 1:2 title "N=10^8" with linespoints ls 3
